...
\033[1;96m ┈┈┈┈▕╲▂▂╱▏┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈▕╲▂▂╱▏┈┈┈┈
\033[1;96m ╱▔▔▔▔┊┊┊┊▔▔▔▔╲☞☞☞☞☞☞\033[1;91m☜☜☜☜☜╱▔▔▔▔┊┊┊┊▔▔▔▔╲
\033[1;96m................\033[1;93mBabaMalik\033[1;91m...............
\033[1;96m................\033[1;93m✬🄵🄰🄲🄴🄱🄾🄾🄺✬\033[1;91m..............

\033[1;96m░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░

\033[1;91m☞ Auther     : Naseema 
\033[1;92m☞ WhatsApp   : 03149507652
\033[1;95m☞ Facebook    : https://www.facebook.com/profile.php?id=100053231773682&mibextid=ZbWKwL
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update Baba Malik Tool')
	print (S + '[' + P + '☞3' + S + ']' + S + ' Baba Malik WhatsApp Group')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/Baba Malik')
	    os.system('cd $HOME && git clone 	
https://github.com/Malikbaba3434/Alisha-Ali-ali.git ')
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('WhatsApp Num 03149507652✓')
	    psb('WellCome To Baba Malik')
	    psb('Congratulations Baba Malik Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ Baba Malik✓')
	    psb('🔓Password ☆ Baba Malik555✓')
	    psb('send friend request https://www.facebook.com/profile.php?id=100053231773682&mibextid=ZbWKwL   ✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/Baba Malik && python2 .py')
	elif bm =='3'
	    menu()
	elif bm =='4':
...
def pak():
	...
	cb()
	print (logo)
	print (S + '[' + P + '☞1' + S + ']' + P + ' Clone With Friend List')1
	print (S + '[' + P + '☞2' + S + ']' + P + ' Clone From Public Account')2
	print (S + '[' + Y + '☞3' + S + ']' + Y + ' Clone From File')3
	print (S + '[' + R + '☞0' + S + ']' + R + ' Back')4
	print
	print (S + 50*'-')
	print
	pb()
...
def pb():
	...
	if bp =='':
		...
		print (logo)
		try:
			idlist=raw_input(S + '[☆] ' + R + 'Enter File Path: ' + B+ '')
